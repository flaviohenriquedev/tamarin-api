package api.tamarin.departamentoPessoal.administracao.cargaHoraria.service;
...
import api.tamarin.departamentoPessoal.administracao.cargaHoraria.repository.CargaHorariaRepository;
...
public class CargaHorariaService extends DefaultServiceImpl<CargaHoraria, CargaHorariaDTO> {
    ...
    @Override
    protected JpaRepository<CargaHoraria, UUID> getRepository() {
